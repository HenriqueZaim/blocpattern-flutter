...
import 'package:youtube_blocpattern/screens/favorites.dart';
import 'package:youtube_blocpattern/widgets/video_tile.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(icon: Icon(Icons.star), color: Colors.black87, onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => Favorites()));
          }),
          IconButton(icon: Icon(Icons.search), color: Colors.black87, onPressed: () async {
